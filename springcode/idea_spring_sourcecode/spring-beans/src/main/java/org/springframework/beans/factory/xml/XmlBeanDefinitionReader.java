...
/**
 * Bean definition reader for XML bean definitions(定义).
 * Delegates(代表) the actual(真实的) XML document reading to an implementation
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	/**
	 * Indicates(表明) that the validation should be disabled.
	 */
