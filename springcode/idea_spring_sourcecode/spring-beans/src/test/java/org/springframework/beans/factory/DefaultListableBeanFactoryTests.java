...
public class DefaultListableBeanFactoryTests {
	...
	@Test1(expected = NoSuchBeanDefinitionException.class)
	...
	@Test1(expected = NoUniqueBeanDefinitionException.class)
	 ...
	 */
	@Test1(expected = TypeMismatchException.class)
	...
	@Test1(expected = IllegalStateException.class)
