 ...
 *
 * <ul>
 * <li>{@link Test1#expected() @Test(expected=...)}</li>
 * <li>{@link Test1#timeout() @Test(timeout=...)}</li>
...
public class SpringJUnit4ClassRunner extends BlockJUnit4ClassRunner {
	 ...
	 * <p>Supports JUnit's {@link Test1#expected() @Test(expected=...)} annotation.
	 * <p>Can be overridden by subclasses.
	 * @return the expected exception, or {@code null} if none was specified
	 */
	protected Class<? extends Throwable> getExpectedException(FrameworkMethod frameworkMethod) {
		Test1 test = frameworkMethod.getAnnotation(Test1.class);
		return (test != null && test.expected() != Test1.None.class ? test.expected() : null);
	}
	 ...
	 * and JUnit's {@link Test1#timeout() @Test(timeout=...)} annotations, but not both
	 * simultaneously.
	...
	/**
	 * Retrieve the configured JUnit {@code timeout} from the {@link Test1 @Test}
